...
@st.cache_data(ttl=10, show_spinner=False)  # Fast 10-second refresh
...
if ticker:
    ...
    with tab1:
        ...
        if candles is not None and not candles.empty:
            ...
            fig_candle.update_layout(title="Last 90 Days Candlestick Chart", height=380, xaxis_rangeslider_visible=False)
...
st.caption("Version 1.0 • 10-second live refresh • Real candlestick + dynamic forecast")
